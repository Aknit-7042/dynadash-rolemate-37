...
import OrgChartMember, { OrgChartMemberProps } from './OrgChartMember';

interface OrgChartProps {
  department: string;
  members: OrgChartMemberProps[];
  onClose: () => void;
}

const OrgChart: React.FC<OrgChartProps> = ({ department, members, onClose }) => {
